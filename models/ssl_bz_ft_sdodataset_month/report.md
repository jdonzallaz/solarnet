...
training_time: 452.04s
model_size: 107458kB
early_stopping_epoch: 0
model_checkpoint_step: 1050
model_checkpoint_epoch: 50
tracking_id: SOLN-389
data:
  class-balance:
    train:
      Quiet: 1248
  ...
  tensor-data:
    min: -1.0
    max: 0.795974612236023
    mean: -0.0002628046495374292
    std: 0.028836458921432495
  set-sizes:
    train: 2568
    val: 261
    test: 265
...
|------------------------------------------------|------------|---------------------|--------|--------|--------|--------|--------|--------|
| models/ssl_bz_ft_sdodataset_month/metrics.yaml | 0.8943     | 0.8951              | 0.8121 | 0.8943 | 0.0833 | 0.7887 | 0.8768 | 0.7902 |
